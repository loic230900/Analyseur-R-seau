/**
 * Définitions pour l'analyse DNS (couche 7 - Application)
 * 
 * Définitions de constantes et prototypes pour le parsing DNS (RFCs 1034, 1035).
 * Ports : UDP/TCP 53. Supporte la compression de noms.
 * 
 */
